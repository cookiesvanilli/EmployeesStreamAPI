...
public class Streams {
    ...
    public void creation() throws IOException {
        ...
        Stream<Employee> employeeStream = emps.parallelStream(); //лучше использовать для больших коллекций
    ...
    public void terminate() {
        ...
        emps.stream().max(Comparator.comparingInt(Employee::getAge)); //emps.stream().max((o1, o2) -> o1.getAge()- o2.getAge())
    ...
    public void transform() {
        ...
        IntStream.of(100, 200, 300, 400, 100, 200).distinct(); // 100, 200, 300, 400 исключены дубликаты
        ...
        emps.stream().takeWhile(employee -> employee.getAge() > 30).forEach(System.out::println);//не принимаем на работу сотрудников старше 30
        //работает как тригер, а не как фильтр. Доходит до первого нужного элемента и последующие принимает как валидные.
        System.out.println();
